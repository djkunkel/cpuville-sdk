...
;**************************************************************
;
;maybe someday?: extern BOOT, WBOOT, CONST, CONIN, CONOUT, LIST, PUNCH, READER, HOME, SELDSK, SETTRK, SETSEC, SETDMA, READ, WRITE, PRSTAT, SECTRN
BOOT:	JP	0		;NOTE WE EXPECT cbios TO OVERLAY
WBOOT:	JP	0
CONST:	JP	0
CONIN:	JP	0
CONOUT:	JP	0
